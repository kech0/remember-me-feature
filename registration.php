...
<div class="form-group">
    ...
    <input type="password" class="from-control" id="password" name="password" placeholder="Password">
</div>

<br>
<button class=btn btn-primary><a href="index.php" style="color:color: white;">Already Have an account ?</a></button>
